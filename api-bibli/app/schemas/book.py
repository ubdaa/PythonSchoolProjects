...
class BookUpdate(BaseModel):
    title: str | None = None
    isbn: str | None = Field(None, pattern=r'^(97(8|9))?\d{9}(\d|X)$', description="ISBN-13 format")
    ...
    language: str | None = Field(None, min_length=2, max_length=3, description="ISO country code")
